...
time()
include("scripts/readdata.jl")
include("scripts/datageneration_decomp.jl")
include("scripts/congestionmodel.jl")
include("scripts/buildsubproblem.jl")
include("scripts/benchmarks/synergylsns.jl")
include("scripts/benchmarks/greedysolution.jl")
include("scripts/dynamicsubproblem/dynamicmlfeatures.jl")
include("scripts/dynamicsubproblem/train.jl")
include("scripts/dynamicsubproblem/generatedynamicsubproblem.jl")
include("scripts/remove.jl")
include("scripts/parsetabucodes.jl")
include("scripts/initializecongestion.jl")
...
include("scripts/checksolution.jl")
...
outputfilename = string("outputs/testinstance", instance_id, "_", methodname, "_run", run_id, ".csv")
lsnsoutputfilename = string("outputs/testinstance", instance_id, "_", methodname, "_run", run_id, "_lsnsiter.csv")
globalsolutionfilename =string("outputs/partitioned/row", run_id,"_output.csv")
...
#Changes orders with multiple of the same item
...
currcong, maps, congestionsignature = initializecongestion()

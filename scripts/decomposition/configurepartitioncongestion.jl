#reducedintersections = getreducedintersections()
#trafficcontribution = directcontributioncalculation()
#traveltimeraw = intersectiontraveltimes(podspeed)
#congestioncontribution, congestionarcs = directcongestioncalculation(trafficcontribution, reducedintersections)
#congestioncontributiony, congestioncontributionz, congestionpairsy, congestionpairsz, congestionlocsy, congestionlocsz, sp_zarc, sp_yarc = directcongestioncalculation_greedy(traveltimeraw, reducedintersections)
#A_traffic = trafficarcset()

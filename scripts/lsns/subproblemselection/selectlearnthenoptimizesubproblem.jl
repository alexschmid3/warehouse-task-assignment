...
function constructbestsubproblem_simple(currpartition, currsol, features, featurenums, featureinfo, windows, windowscontaining, windowidlookup, windowsduring, windowsynergy, unassignedorders, tabulist, lastoptimizeddifference, sp_iter)
...
function selectlearnthenoptimizesubproblem_simple(currpartition, currsol, windows, windowscontaining, windowidlookup, windowsduring, windowsynergy, targetnumorders, targetnumpods, tabulist, lastoptimizeddifference, sp_iter)

	assignedorders_all, unassignedorders = findallunassignedorders(currpartition, currsol)
	objective, x, alpha, zeta = constructbestsubproblem_simple(currpartition, currsol, features, featurenums, featureinfo, windows, windowscontaining, windowidlookup, windowsduring, windowsynergy, unassignedorders, tabulist, lastoptimizeddifference, sp_iter)
	sp_winid, sp_orders, sp_window, sp_pods, sp_itemson, sp_items, tabulist = parseoptimizationoutput(windows, currpartition, currsol, x, alpha, zeta, tabulist)

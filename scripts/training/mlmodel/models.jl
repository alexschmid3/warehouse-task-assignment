...
function linearregressionmodel_nocongestion(sp_workstations, sp_pods, sp_orders, sp_times, actualobj, probleminstances, numsubproblems, featurelookup, featuresforprediction_wt, featuresforprediction_mp, featuresforprediction_pw, featuresforprediction_pwt, w_features, t_features, m_features, p_features, wt_features, mp_features, pw_features, pwt_features, w_featnums, t_featnums, p_featnums, m_featnums, wt_featnums, mp_featnums, pw_featnums, pwt_featnums, setbetas, traincongestion_flag, trainassignment_flag, weight)
	...
	return value.(beta_wt), value.(beta_mp), value.(beta_pw), value.(beta_pwt), value.(pred), [value(beta_m), value(beta_p), value(beta_w), value(beta_t), 0]
...
function linearregressionmodel_intercept(sp_workstations, sp_pods, sp_orders, sp_times, actualobj, probleminstances, numsubproblems, featurelookup, featuresforprediction_wt, featuresforprediction_mp, featuresforprediction_pw, featuresforprediction_pwt, w_features, t_features, m_features, p_features, wt_features, mp_features, pw_features, pwt_features, w_featnums, t_featnums, p_featnums, m_featnums, wt_featnums, mp_featnums, pw_featnums, pwt_featnums, setbetas, traincongestion_flag, trainassignment_flag, weight)
	...
	@variable(model, beta_m)
	@variable(model, beta_w)
	@variable(model, -10000 <= beta_0 <= 10000)
	...
	return value.(beta_wt), value.(beta_mp), value.(beta_pw), value.(beta_pwt), value.(pred), [value(beta_m), value(beta_p), value(beta_w), value(beta_t), value(beta_0)]
...
function linearregressionmodel_compare(sp_workstations, sp_pods, sp_orders, sp_times, actualobj, probleminstances, numsubproblems, featurelookup, featuresforprediction_wt, featuresforprediction_mp, featuresforprediction_pw, featuresforprediction_pwt, w_features, t_features, m_features, p_features, wt_features, mp_features, pw_features, pwt_features, w_featnums, t_featnums, p_featnums, m_featnums, wt_featnums, mp_featnums, pw_featnums, pwt_featnums, setbetas, traincongestion_flag, trainassignment_flag, weight)
	...
	return value.(beta_wt), value.(beta_mp), value.(beta_pw), value.(beta_pwt), value.(pred), [value(beta_m), value(beta_p), value(beta_w), value(beta_t), 0], value.(alpha_m), value.(alpha_p), value.(alpha_w), value.(alpha_t)
